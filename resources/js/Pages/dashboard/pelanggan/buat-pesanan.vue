...
<template>
    ...
    <AppLayout>
        ...
        <div class="bg-gray-50 min-h-screen pb-32 lg:pb-16">
            <div class="max-w-2xl mx-auto px-4 mt-6 relative z-20 space-y-5">

                <!-- Back -->
                <button 
                    @click="goBack" 
                    class="flex items-center text-[11px] font-black text-gray-400 hover:text-[#E30613] uppercase tracking-widest transition-colors group"
                >
